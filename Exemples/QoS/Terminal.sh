# =================================================================================================================================================================================
#
# Interfaces  Adresse IP        Passerelle      POOL    Plage IP  
# ether1-wan  192.168.200.50    192.168.200.1   ----    -----------------------------
# ether2-lan  192.168.220.1     -------------   LAN     192.168.220.2-192.168.220.254
# ether3-dmz  192.168.240.1     -------------   DMZ     192.168.240.2-192.168.240.10
#
# Routes
...
# NAT: 53, 80, 443, 8080
#
# Mangle: (Mark Connexion: WAN | LAN) | (Mark Packet : 53, 80, 443, 8080)
# Queues: Quality Of Services
#
# =================================================================================================================================================================================
